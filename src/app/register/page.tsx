  ...
  return (
    <main className="flex items-center justify-center h-screen w-screen bg-white">
      <form
        ...
        className="w-[600px] h-[710px] bg-white rounded-[10px] py-[10px] px-[10px] flex flex-col  gap-3 items-center justify-between shadow-2xl"
      >
            ...
            <div className="w-full flex flex-row items-center justify-between gap-5">
              ...
              <div className="flex flex-col w-full">
                ...
                <Listbox value={service} onChange={setService}>
                  <div className="relative">
                    <ListboxButton
                      className={`w-full h-9 bg-gray-200 rounded-[7px] text-black px-4 pr-10 text-left ${
                        role === 'Provider'
                          ? 'cursor-pointer'
                          : 'cursor-not-allowed'
                      }`}
